var ROS3D = (function (exports, THREE$1, ROSLIB, BufferGeometryUtils_js) {
  'use strict';
    ...
    constructor(options) {
      ...
      switch (message.type) {
        ...
        case MARKER_LINE_STRIP:
          const lineStripMaterial = new THREE_MeshLine.exports.MeshLineMaterial({
          ...
          const lineStrip = new THREE_MeshLine.exports.MeshLine();
        ...
        case MARKER_LINE_LIST:
          const lineListMaterial = new THREE_MeshLine.exports.MeshLineMaterial({
            lineWidth: Math.max(1.0, message.scale.x),
            sizeAttenuation: true,
          });
          ...
          const lineList = new THREE_MeshLine.exports.MeshLine();
...
}({}, THREE$1, ROSLIB, BufferGeometryUtils_js));
